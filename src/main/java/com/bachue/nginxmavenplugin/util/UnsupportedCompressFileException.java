...
/**
 * If compress format is not supported
 * @author Alejandro Vivas
 * @version 17/08/2017 0.0.1-SNAPSHOT
 * @since 17/08/2017 0.0.1-SNAPSHOT
 */
public class UnsupportedCompressFileException extends Exception
{
	/**
	 * @author Alejandro Vivas 
	 * @version 17/08/2017 0.0.1-SNAPSHOT
	 ...
	 * @since 17/08/2017 0.0.1-SNAPSHOT
	 */
	public UnsupportedCompressFileException(String message)
	{
		super(message);
	}	
}
